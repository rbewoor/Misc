...
###
###  NOTE: Expects 13 command line parameters (including the script name)
#######################################################################################
#
Usage example with position numbers indicated:
                    0                                       1                     2  3           4
python </script/folder/path/programName.py> </input/file/with/path/filename.csv> -1 0 </output/file/path/wavsHere/>
            5                        6                                       7
</output/file/path/csvs/> </outputFileNameForDeepspeech.csv> </outputFileNameNOTForDeepspeech.csv>
8  9  10 11             12
20 60 50 1 </path/for/logFile/logFileName.log>
...
if len(sys.argv) != 13:
    ...
    print(f"\npython </script/folder/path/<programName.py> </input/file/with/path/filename.csv> -1 0 </output/file/path/wavsHere/> </output/file/path/csvs/> </outputFileNameForDeepspeech.csv> 20 60 50 0 </path/for/logFile/logFileName.log> </outputFileNameNOTForDeepspeech.csv>\n")
